                ...
                <>
                    ...
                    <div className="d-flex flex-wrap justify-content-around">
                        {props.one.places.map((place, idx) => {
                            ...
                            return (
                                <a
                                    className="border rounded col-sm-4 m-1 p-1 d-flex flex-wrap align-items-center justify-content-center"
                                    key={idx}
                                    href={placeUrl}
                                    target="_blank"
                                    rel="noreferrer noopener"
                                >
                                    <p className="extra-sml-text">
                                        {placeName}
                                    </p>
                                </a>
                            );
